TXT = {
    ...
    "MUSULMONMEHMONXONA": {
        "uz": "Musulmonlar uchun mehmonxonalar",
        "ru": "Гостиницы для мусульман",
        "en": "Hotels for Muslims",

    },
    "MEHMONXONATANLASH": {
        "uz": "Mehmonxonani tanlang",
        "ru": "подобрать отель",
        "en": "choose a hotel",
    ...
    "c1Title": {
        "uz": "Yanvardan boshlab biz bilan umraga safar qiling !",
        "en": "Yanvardan boshlab biz bilan umraga safar qiling !(en)",
        "ru": "Yanvardan boshlab biz bilan umraga safar qiling !(ru)"
    },
...
BIGTXTNAME = {
    ...
    "HADIS1": {
        "uz": "SAFARGA SHERIK TANLASH",
        "ru": "ВЫБЕРИТЕ ПАРТНЕРА ПО ПУТЕШЕСТВИЮ",
        "en": "CHOOSE A TRAVEL PARTNER",
    }, "HADIS2": {
        "uz": "SAFARGA BOSHLIQ TANLASH",
        "ru": "ВЫБЕРИТЕ ГЛАВУ ПОЕЗДКИ",
        "en": "CHOOSE THE HEAD OF THE TRIP",
    }, "HADIS3": {
        "uz": "SAFAR QILISH MUSTAHAB BO'LGAN KUNLAR",
        "ru": "РЕКОМЕНДУЕМЫЕ ДНИ ДЛЯ ПОСЕЩЕНИЯ",
        "en": "RECOMMENDED DAYS TO VISIT",
    }, "HADIS4": {
        "uz": "JUM`A KUNI SAFAR QILISH",
        "ru": "ПУТЕШЕСТВИЕ В ПЯТНИЦУ",
        "en": "TRAVEL ON FRIDAY",
    }, "HADIS5": {
        "uz": "ULOVGA MINGANDAGI DUO",
        "ru": "МОЛИТВА НА ГОРЕ",
        "en": "A PRAYER ON A MOUNTAIN",
    }, "HADIS6": {
        "uz": "ULOVGA MINGANDAGI DUO",
        "ru": "МОЛИТВА НА ГОРЕ",
        "en": "A PRAYER ON A MOUNTAIN",
...
BIGTXT = {
    ...
    "HADIS3": {
        "uz": "Ka`bibnMolikroziyallohuanhudanrivoyatqilinadi:“Rasulullohsollallohualayhivasallamko'proqpayshanbakunlarisafarqilaredilar”.Uzotdushanbakunisafarqilishnihamyoqtiraredilar. Shuninguchunbirorzaruratbo'lmasa, safarnishukunlargabog'lashmustahabdir.",
        "ru": "Передается от Кааба ибн Малика, да благословит его Аллах и приветствует: «Посланник Аллаха, да благословит его Аллах и приветствует, путешествовал по четвергам». Поэтому, если нет необходимости, мустахаб связывать поездку с этими днями.",
        "en": "It is narrated from Ka'b ibn Malik, may God bless him and grant him peace: 'The Messenger of God, may God's prayers and peace be upon him, used to travel on Thursdays." "He also liked to travel on Mondays. Therefore, if there is no necessity, it is mustahab to connect the trip to these days."
    },
    "HADIS4": {
        "uz": "AgarJum`akunisafarqilishgato'g'rikelibqolsa, zavol (ya`niJum`avaqtikirishi)danoldinyo'lgachiqilsa, hechqandaymakruhlikbo'lmaydi, garchiJum`ao'qilmaydiganjoygaborilsaham. Zavoldankeyin, jum`ao'qilishidanoldinsafargachiqishlikmakruhitahrimiydir. Chunki, muqimkishigajum`avaqtikirganidanso'ngjum`agaborishligivojibdir.Ibn Umar roziyallohuanhudanrivoyatqilinadi:“Jum`anamozisafardan man qilmaydi, modomikinamozvaqtikiribqolmaganbo'lmasa” (Kanz ul-Ummol).",
        "ru": "Если вы путешествуете в пятницу, если вы уезжаете до завала (т. Отправляться в путь после Заваля до прочтения Джумуа является макрухом. Потому что для жителя обязательно идти в пятницу после времени пятницы.",
        "en": "If you happen to travel on Friday, if you leave before zawal (i.e. the time of Friday), there is no makruh, even if you travel to a place where Friday is not observed. . It is makruh to go on a journey after Zawal, before Jumu'ah is read. Because it is obligatory for a resident to go to Friday after the time of Friday.",

    },
    "HADIS5": {
        "uz": "AbdullohibnUmarroziyallohuanhudanrivoyatqilinadi:“Nabiysollollohualayhivasallamulovlarigaminganlaridauchbortakbiraytar so'ngra:“SubhanallaziysaxxorolanaahazavamaakunnaalahumuqriniynavainnaailaaRobbinaalamunqolibuun”, deredilar.Duoning ma`nosi:“Bizlargabu (markab)nibo'ysundiribqo'yganZotaybunuqsondanpokdir. Bizlaro'zimizbungaqodiremasedik. Shak-shubhasiz, bizlar (barchamiz) Robbimizgaqaytguvchidirmiz”. ",
        "ru": "Передается от Абдуллаха ибн Умара, да благословит его Аллах и приветствует: «Когда Пророк, да благословит его Аллах и приветствует, трижды произносил такбир, то он говорил: Субханаллазисаххара лана хаза вамакунналахумукринийнаваиннааиляраббиналанумкалибуун». Смысл молитвы: «Для нас Тот, кто подчинил себе этот (маркаб), чист от вины и порока. Мы не могли сделать это сами. Несомненно, мы (все) возвращаемся к нашему Господу.",
        "en": 'It is narrated from Abdullah ibn Umar, may God bless him and grant him peace: ""When the Prophet, may God bless him and grant him peace, used to say takbir three times, then he would say: SubhanallazisakhharalanaahazawamaakunnaalahumuqriniynawainnaailaaRabbinaalanumqalibuun." The meaning of the prayer: "To us The One who subjugated this (markab) is pure from fault and defect. We could not do it ourselves. Undoubtedly, we (all) are returning to our Lord.',
    },
    "HADIS6": {
        "uz": "",
        "ru": "Передается от Абдуллаха ибн Умара, да благословит его Аллах и приветствует: «Когда Пророк, да благословит его Аллах и приветствует, трижды произносил такбир, то он говорил: Субханаллазисаххара лана хаза вамакунналахумукринийнаваиннааиляраббиналанумкалибуун». Смысл молитвы: «Для нас Тот, кто подчинил себе этот (маркаб), чист от вины и порока. Мы не могли сделать это сами. Несомненно, мы (все мы) возвращаемся к нашему Господу».",
        "en": 'It is narrated from Abdullah ibn Umar, may God bless him and grant him peace: "When the Prophet, may God bless him and grant him peace, used to say takbir three times, then he would say: SubhanallazisakhharalanaahazawamaakunnaalahumuqriniynawainnaailaaRabbinaalanumqalibuun." The meaning of the prayer: "To us The One who subjugated this (markab) is pure from fault and defect. We could not do it ourselves. Undoubtedly, we (all of us) are returning to our Lord.',
